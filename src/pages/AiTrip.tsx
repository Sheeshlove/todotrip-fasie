...
const AiTrip = () => {
  ...
  return <PageLayout title={`ToDoTrip - ${city}`} description={`AI-маршрут по городу ${city}`}>
      <div className="flex flex-col min-h-[calc(100vh-160px)] pt-8 pb-24 max-w-md mx-auto w-full px-[29px] py-[102px]">
        ...
        <div className="flex flex-col space-y-6 w-full">
          {showResults ? <UnderDevelopmentMessage /> : <TripPreferencesForm onSubmit={handleSubmitPreferences} />}
        </div>
      </div>
    </PageLayout>;
};
