...
export const TestQuestionView = ({
  ...
  // Get the trait category based on the question's trait property
  const getTrait = (trait: string): string => {
    switch(trait) {
      case 'openness': return "Открытость опыту";
      case 'conscientiousness': return "Добросовестность";
      case 'extraversion': return "Экстраверсия";
      case 'agreeableness': return "Доброжелательность";
      case 'neuroticism': return "Нейротизм";
    ...
    <>
      <div className="mb-6">
        ...
        <div className="flex justify-between mt-1">
          <p className="text-sm text-todoMediumGray">
            {getTrait(currentQuestion.trait)}
          </p>
          <p className="text-sm text-todoMediumGray">
      ...
      <div className="flex justify-between">
        <Button 
          ...
          className="border-todoMediumGray font-bold bg-red-600 hover:bg-red-500 text-slate-50"
        >
        ...
        {isSubmitting ? (
          <Button disabled className="bg-todoYellow text-black hover:bg-yellow-400">
