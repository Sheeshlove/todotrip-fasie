...
export const EmptyState: React.FC<EmptyStateProps> = ({
  ...
  return <div className="flex flex-col items-center justify-center text-center">
      ...
      <Card className="bg-todoDarkGray/50 backdrop-blur-sm border-white/5 rounded-xl p-8 max-w-md w-full shadow-lg">
        ...
        <p className="text-lg mb-8 text-todoLightGray">Больше никого нет, пригласи друзей!</p>
        
        <Button onClick={onInviteFriends} className="bg-todoYellow text-black hover:bg-yellow-400 transition-all font-bold py-3 px-6 rounded-lg w-full flex items-center justify-center">
